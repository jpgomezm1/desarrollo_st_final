...
def main():
    ...
    ANTHROPIC_API_KEY = "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"
    ...
    analyzer = MeliVehicleAnalyzer(ANTHROPIC_API_KEY)
